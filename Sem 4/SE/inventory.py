...
class Order:
    def __init__(self, order_id, supplier, products_ordered):
...
class Inventory:
    ...
    def add_product(self):
        ...
        print(f"Product added successfully! ID: {self.cursor.lastrowid}")
    ...
    def add_supplier(self):
        ...
        self.cursor.execute("INSERT INTO suppliers (name, contact) VALUES (?, ?)", 
                            (name, contact))
        self.connection.commit()
        print(f"Supplier added successfully! ID: {self.cursor.lastrowid}")
    ...
    def place_order(self):
        ...
        self.cursor.execute("INSERT INTO orders (supplier_id, status) VALUES (?, ?)", 
                            (supplier_id, "Pending"))
    ...
    def complete_order(self):
        ...
        if order_data:
            if order_data[2] == "Pending":
                self.cursor.execute("SELECT product_id, quantity FROM order_items WHERE order_id = ?", (order_id,))
                ...
                self.connection.commit()
                print("Order marked as completed successfully! Inventory updated.")
            else:
